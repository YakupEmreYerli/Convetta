<script lang="ts">
	...
	/**
	 * Sorular disaridan veriliyor: her aracin kendi SSS'si var ve dönüştürücünün
	 * sorulari boyutlandirici sayfasinda gorunmemeli. Varsayilan yok, cunku
	 * "unutulunca ana sayfanin sorulari gelsin" davranisi tam da duzeltilen hata.
	 */
	interface Props {
		title: string;
...
<div class="mx-auto w-full max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
	<section
		id="faq-container"
		class="rounded-2xl bg-white p-8 shadow-xl sm:p-10 dark:bg-slate-800"
	...
	>
		...
		<div>
			{#each items as item, index (item.q)}
